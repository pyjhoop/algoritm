...
| :---: | :--- | :---: | :--- | :---: |
| **수 (Warm-up)** | [폰켓몬](https://school.programmers.co.kr/learn/courses/30/lessons/1845) | Lv.1 | `HashSet`을 이용한 중복 제거 및 단순 분기 | [ ] |
| **목 (Warm-up)** | [같은 숫자는 싫어](https://school.programmers.co.kr/learn/courses/30/lessons/12906) | Lv.1 | 기본 배열/리스트 순회 및 직전 원소 비교 (스택 원리) | [ ] |
